...
import { select } from "mzinga/dist/fields/validations";

const access = new AccessUtils();
const collectionUtils = new CollectionUtils(Slugs.Communications);

const useExternalWorker = process.env.COMMUNICATIONS_EXTERNAL_WORKER == "true";
...
const Communications: CollectionConfig = {
  ...
  fields: [
    ...
    //readOnly:true,
    //position: Postion.sidebar include
    },
    {
      name: "subject",
      type: "text",
